def job_information_prompt_combining(preprocessed_text):
    prompt = \
        ...
        the skills should be single words or brief noun phrases that clearly represent a skill or ability.

    Example 1: Job Description: The candidate should have experience in Java programming, teamwork, and effective 
    ...
    Example 2: Job Description: Seeking a professional with skills in graphic design, Adobe Photoshop, 
...
def resume_education_prompt_combining(preprocessed_text):
    ...
    primary field of study for each student. Ignore any non-text formatting characters and focus solely on 
    identifying subject in the education section. If no subject can be identified, output 'n/a'
    
    The subject must be one from 
    the following list: [African Studies, Anthropology, Art History and Visual Culture, Arts and Science Co-op, Arts, 
    Culture and Media, Arts Management, Astronomy, Biological Sciences, Certificates, Chemistry, City Studies, 
    Classical Studies, Combined Degree Programs, Computer Science, Concurrent Teacher Education, Curatorial Studies, 
    Diaspora and Transnational Studies, Double Degree Programs, Economics for Management Studies, English, 
    Environmental Science, Environmental Studies, Food Studies, French, Geography, Global Asia Studies, 
    Global Leadership, Health Studies, Historical and Cultural Studies, History, International Development Studies, 
    International Development Studies (IDS) Co-op, International Studies, Journalism, Languages, Linguistics, 
    Management, Management Co-op, Mathematics, Media, Journalism, and Digital Cultures, Music and Culture, 
    Neuroscience, New Media Studies, Paramedicine, Philosophy, Physical Sciences, Physics and Astrophysics, 
    Political Science, Psycholinguistics, Psychology, Public Policy, Religion, Sociology, Statistics, Studio Art, 
    Theatre and Performance, Women's and Gender Studies]
